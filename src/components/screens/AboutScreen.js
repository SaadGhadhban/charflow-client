      ...
      <div className="about-section">
        <div className="about-section-one">
          ...
          <p className="about-para">
            Visualize your data and statistics quickly and easily with Chart
            Flow's online chart maker
          </p>
          <p className="about-para">
          ...
          <p className="about-para">
            ...
            functionalities to authenticate and store user passwords in the
            database and JWT for authorization{" "}
          </p>
