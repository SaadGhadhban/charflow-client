    ...
    for (let i = 0; i < data.length; i++) {
      for (let j = 0; j < data[i].chartType.length; j++) {
        ...
        if (data[i].chartType[j] === "Doughnut") {
          setDoughnutCharts((doughnutCharts) => [
            ...doughnutCharts,
            data[i].chartType[j],
          ]);
        }
    ...
    <div className="main">
      ...
      <div className="boxes-contaier">
        ...
        <div
          ...
          onClick={() => setChartFilter("Doughnut")}
        >
      ...
      {chartFilter ? (
        <div className="reset-btn-container">
          <button className="reset-btn" onClick={() => setChartFilter("")}>
            {" "}
            <MdClear size={"1.5em"} color={"#e76f51"} /> Reset filter
          </button>
        </div>
      ) : (
        ""
                    ...
                    <div key={v4()} className="chart-c">
                      ...
                      <div className="chart-futter">
                        ...
                        <div className="user-section">
                          ...
                          <h4 className="username">{privateData}</h4>
                        </div>
                      </div>
                      ...
                      <div className="btn-container">
                        ...
                        {isPrivate ? (
                          <IoIosLock className="futter-icon" size="1em" />
                        ) : (
